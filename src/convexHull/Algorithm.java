...
public class Algorithm {
	...
	public static long cross(Coordinate o, Coordinate a, Coordinate b) {
		return (a.getXPosition() - o.getXPosition()) * (b.getYPosition() - o.getYPosition())
				- (a.getYPosition() - o.getYPosition()) * (b.getXPosition() - o.getXPosition());
	}

	/**
	 * Function definition for convexHull()
	 * <p>
	 * Starts by sorting the coordinate array. Determines the lower and upper hulls,
	 * removing the duplicate points. Then the coordinate array is returned.
	 * <p>
	 * 
	 * @param c
	 *            is the array of coordinates to have a hull determined
